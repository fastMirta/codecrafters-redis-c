...
int handle(RespRequest *req, Client *client) {
    ...
    if (req->command == PSYNC) {
        ...
        unsigned char empty_rdb[] = {
            ...
            0x6d, 0x08, 0xbc, 0x65, 0xfa, 0x08, 0x75, 0x73, 0x65, 0x64, 0x2d, 0x6d, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x10, 0xaa, 0x02, 0x7a, 0x56, 0x95, 0x62, 0x41
        };
